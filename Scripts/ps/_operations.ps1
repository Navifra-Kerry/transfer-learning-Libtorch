Function Set-OperationsInfo
{
    @(
        ...
        @{Name = "Libtorch 1.5 Install"; ShortName = "LIBTORCH-1.5"; Info = "Install LIBTORCH-1.5";
          Verification = @( @{Function = "VerifyDirectory"; Path = "$LibTorchPath"; } );
          Download = @( @{Function = "Download"; Source = "https://download.pytorch.org/libtorch/cu102/libtorch-win-shared-with-deps-1.5.0.zip"; Destination = "$localCache\libtorch-win-shared-with-deps-1.5.0.zip" } );
